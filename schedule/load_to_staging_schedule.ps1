...
$projectPath = "E:\Python\DW_MecKey\loadToStaging"
$scriptPath = "$projectPath\main.py"

$schedules = @(
    @{Name = "RunAkko_Process"; Param = "--auto -pn akko_process"; Time = "09:30AM" },
    @{Name = "RunCps_Process"; Param = "--auto -pn cps_process"; Time = "09:40AM" }
)
